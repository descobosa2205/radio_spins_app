...
- ⚠️ **EL BUZÓN DE CADA PERSONA (Integraciones → Correo) YA LO USAN DOS COSAS** (sep 2026): la
  **presentación de un tema a una emisora** y las **INVITACIONES CORPORATIVAS**
  ...
  ⚠️ En las invitaciones **no hay salida alternativa**: sin su cuenta configurada **no se manda** y
  se dice qué falta (`_user_mail_account_problem` distingue «desactivada» de «sin contraseña»).
  Mandarla con el remitente de la casa sería mentir sobre quién invita.
